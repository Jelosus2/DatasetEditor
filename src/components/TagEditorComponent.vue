  ...
  <div class="w-[30%] pt-1 pr-1">
    ...
    <div class="flex flex-col" :style="{ height: tagGroupSectionBottomHeight + '%' }">
      ...
      <div class="mt-auto flex gap-2 border-t-2 border-gray-400 pt-1 dark:border-base-content/10">
        <div class="tooltip" :class="{ 'tooltip-success': areTagsCopied }" :data-tip="areTagsCopied ? 'Tags copied!' : 'Click to copy the global tags'">
          <button class="btn btn-circle border-none p-0.5 btn-sm btn-ghost dark:hover:bg-[#323841]" :disabled="!displayedGlobalTags.size" @click="copyTextToClipboard(displayedGlobalTags)">
            <svg class="h-full w-full fill-none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
